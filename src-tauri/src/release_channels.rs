...
const STABLE_UPDATE_ENDPOINT: &str =
    "https://raw.githubusercontent.com/QWERT/QWERT/update-manifests/stable/latest.json";
const ALPHA_UPDATE_ENDPOINT: &str =
    "https://raw.githubusercontent.com/QWERT/QWERT/update-manifests/alpha/latest.json";
